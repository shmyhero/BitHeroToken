...
/**
 * @title Basic token
 * @dev Basic version of BitHeroToken, with no allowances.
 */
contract BasicToken is ERC20Basic {
	event Deposit(uint index, address indexed from, address indexed to, uint value);	
	event Refund(uint index, address indexed to, uint value);
...
contract BitHeroToken is StandardToken, Ownable {
    string public constant symbol = "BHT";
    string public constant name = "BitHeroToken";
